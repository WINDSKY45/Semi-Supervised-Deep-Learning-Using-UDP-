...
def UDP_for_CNN(yl, yn, yr, wij_n, wij_r, batch_size = 10, num_classes = 10):
    with tf.name_scope('UDP_CNN'):
        loss = Laplacian_Eigenmaps_forCNN(yl, yn, wij_n, batch_size, num_classes)/Laplacian_Eigenmaps_forCNN(yl, yr, wij_r)
        return loss
